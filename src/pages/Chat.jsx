...
export default function Chat(){
    ...
    async function loadConversations(){
        try{
            ...
            console.error('Erro loading conversation :', err);
        }finally{
            setLoading(false);
        }
    }
    ...
    async function handleDeleteConversation(conversationId) {
        if(!window.confirm('Delete this converstation?')){
            return;
        }
        try{
    ...
    <div className="chat-page">
          ...
          {conversations.length === 0 ? (
            ...
            conversations.map((conv) => (
              ...
              >
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation(); // Don't select conversation when deleting
      ...
      <div className="chat-main">
        {currentConversationId ? (
          // Show chat interface if conversation selected
